                ...
                <div className="col-6">
                    ...
                    <div className="row mb-3">
                        ...
                        <div className="col-5 pl-0">
                            <input type="text" placeholder="Bairo" className="form-control form-control-lg" />
                        </div>  
                    ...
                    <div className="row mb-3">
                        <div className="col-12">
                            <input type="text" placeholder="Núnmero do Cartão" className="form-control form-control-lg" />
                        </div>  
                    </div>
                    <div className="row mb-3">
                        <div className="col-6">
